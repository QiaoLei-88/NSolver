...
namespace NSFEMSolver
{
  ...
  NSolver<dim>::refine_grid()
  {
    switch (parameters->refinement_indicator)
      {
        ...
        case Parameters::Refinement<dim>::Kelly:
          {
            NSFEMSolver::Tools::refine_and_coarsen_fixed_number(
              triangulation, refinement_indicators, parameters);
            break;
          }
    ...
    parallel::distributed::SolutionTransfer<dim, NSVector> soltrans(
      dof_handler);
