  ...
  while (counter < prt_parameters->max_refine_level + 3)
    {
      // fabricate a refine criteria
      {
        ...
        for (; cell != endc; ++cell)
          if (cell->is_locally_owned())
            {
              criteria[cell->active_cell_index()] = cell->active_cell_index();
      ...
      //       {
      //         {
      //           const float old_flag =
      //           refine_mark[cell->active_cell_index()]; const float new_flag
      //           = (cell->refine_flag_set()
      //                                   ?
      //                                   1.0
      //                                   :
      //                                   0.0);
      //           refine_mark[cell->active_cell_index()] = (old_flag !=
      //           new_flag
      //                                                     ?
      //                                                     1.0
      //                                                     :
      ...
      //         {
      //           const float old_flag =
      //           coarsen_mark[cell->active_cell_index()]; const float new_flag
      //           = (cell->coarsen_flag_set()
      //                                   ?
      //                                   1.0
      //                                   :
      //                                   0.0);
      //           coarsen_mark[cell->active_cell_index()] = (old_flag !=
      //           new_flag
      //                                                      ?
      //                                                      1.0
      //                                                      :
