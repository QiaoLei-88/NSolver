...
namespace NSFEMSolver
{
  ...
  private:
    ...
    initialize();
    void
    check_negative_density_pressure() const;
    ...
    /**
     * This function set proper value for laplacian_indicator and
     * laplacian_threshold.
     */
    void
    calc_laplacian_indicator();
    /**
     * Compute infinity norm of solution and/or gradient jumps across all faces
     * in &p cell.
     */
    double
    calc_jumps(const FEFaceValuesBase<dim> &fe_v_face_this,
    ...
    /**
     * Apply Laplacian continuation to system matrix and residual. The
     * coefficients are depending to system residual and solution jump. So this
     * procedure can not be embedded into assemble_system().
     */
    void
    ...
    solve(NSVector &solution, const double absolute_linear_tolerance);

    void
    integrate_force(WallForce &wall_force) const;
    ...
    // Must appear before Triangulation to make it initialized before
    // triangulation and destroyed after triangulation.
